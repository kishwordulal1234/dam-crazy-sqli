...
banner5() {
   ...
   ${G}    .---.        .----------- ${N}
  ${G}    /     \  __  /    ------ ${N}
   ${G}  / /     \(  )/    -----  ${N}   \033[7;36m PSQL-I v.3 moded by unknone hart ${N}\033[1;36m\033[1m FINAL${N}
  ${G}  //////   ' \/ \`   ---   ${N}    \033[2m |==┣▇▇▇▇▇▇▇▇═─-SQl-i ${N}
...
banner4() {
  echo -e " 
                    \033[7;31m PSQL-I v.3 moded by unknone hart ${N}${R} FINAL${N}
                          /
...
banner2() {
echo -e "                    \033[7;31m PSQL-I v.3 moded by unknone hart ${N}${R} FINAL${N}${G}"
cat << "EOF"
                        /
       　　　/)        /  
 ...
 2) masn="y"
  ...
  5) masn="n"
   ...
   9) clear
      ...
      case $p in
        1) clear
           banner${angkab}
           echo -e "                |\033[7;32m Query Email Pass dumper + auto filter mail ${N}|\n"
           read -p "enter sqli query that has been dumped email pass: " line
           line=$(echo "${line}" | sed "s/-- -/--+/g")
           email
           menu
           ;;
        2) clear
           banner${angkab}
           echo -e "                |\033[7;32m Query Email Pass dumper + auto filter mail ${N}|\n"
           read -p "enter list file query sqli that has been dumped email pass: " file
   ...
   13)  clear
      ...
      clear
      banner${angkab}
      echo -e "          |\033[7;32m Psqli Sqli/Xss/LFI/AdminFinder Scanner mass ${N}|\n"
      read -p "site list: " list
      rm -rf .result_dork .not .url .vuln .bad .wp .live
      trap break INT
...
unknone_loader() {
    ...
    cat << 'EOF'
                          __         __   __                                 __             __ 
   ____ ___  ____  ____/ /__  ____/ /  / /_  __  __   __  ______  / /______  ____  ___     / /_  ____ ______/ /_
  / __ `__ \/ __ \/ __  / _ \/ __  /  / __ \/ / / /  / / / / __ \/ //_/ __ \/ __ \/ _ \   / __ \/ __ `/ ___/ __/
 / / / / / / /_/ / /_/ /  __/ /_/ /  / /_/ / /_/ /  / /_/ / / / / ,< / /_/ / / / /  __/  / / / / /_/ / /  / /_  
/_/ /_/ /_/\____/\__,_/\___/\__,_/  /_.___/\__, /   \__,_/_/ /_/_/|_|\____/_/ /_/\___/  /_/ /_/\__,_/_/   \__/  
                                          /____/                                                             
EOF
    echo -e "\033[0m"
    
    echo -e -n "\033[0;32mInitializing PSQL-I v.3 moded by unknone hart... \033[0m ["
    for i in {1..20}; do
        echo -n "█"
        sleep 0.05
    done
    echo "]"
    echo -e "\033[0;31mLoading completed! Starting framework...\033[0m"
    sleep 1
}
